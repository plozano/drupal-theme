          ...
          <div class="pull-right">
                        <div class="top-info">
                            ...
                            <div class="login-container">
                                <a class="btn btn-login" href="https://login.five9.com">
...
<main class="container-fluid wrapper <?php print $container_class; ?>">
  ...
  <?php endif; ?>
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <?php if (!empty($title)): ?>
      <!-- <div id="content" --> <?php //print 'class="column ' . $node->type . '"'; ?> r<!-- ole="main"> -->
...
<?php endif; ?>
     ...
     <?php if (!empty($page['documents'])): ?>
      <section class="knowledge-multiple container-fluid">
          <div class="container">
            <div class="row">
